...
The problem I want to solve in this project is to identify potentially volatile accounts that have the capability of causing social unrest and civil disobedience. These accounts should be able to be banned before anything dangerous should occur.
